...
# def query(question, pdf_path, model_name=model_name):
...
#     similarities = [compute_similarity(question_embedding, emb) for emb in embeddings]
...
#     pdf_path = data.get('pdf_path')  # URL or local path
...
#         # Process the PDF
#         answer = query(question, pdf_path)
